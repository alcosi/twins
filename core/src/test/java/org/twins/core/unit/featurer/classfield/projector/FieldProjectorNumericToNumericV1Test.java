...
class FieldProjectorNumericToNumericV1Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorNumericToNumericV1 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorNumericToNumericV1();
