...
class FieldProjectorStringToDataListV4Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorStringToDataListV4 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorStringToDataListV4();
