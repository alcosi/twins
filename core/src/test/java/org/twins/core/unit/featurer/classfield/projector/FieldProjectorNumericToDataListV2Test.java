...
class FieldProjectorNumericToDataListV2Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorNumericToDataListV2 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorNumericToDataListV2();
