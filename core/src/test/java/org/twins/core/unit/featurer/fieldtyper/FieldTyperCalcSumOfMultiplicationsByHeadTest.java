...
class FieldTyperCalcSumOfMultiplicationsByHeadTest extends BaseUnitTest {

    @Mock
    private TwinFieldDecimalRepository twinFieldDecimalRepository;

    private FieldTyperCalcSumOfMultiplicationsByHead fieldTyper;

    @BeforeEach
    void setUp() {
        fieldTyper = new FieldTyperCalcSumOfMultiplicationsByHead(twinFieldDecimalRepository);
    }
    ...
    class GetStorage {
        ...
        @Test
        void getStorage_returnsSumOfMultiplicationsByHeadStorageWithRepositoryInjected() {
            var classField = new TwinClassFieldEntity();
            classField.setId(UUID.randomUUID());
            ...
            assertInstanceOf(TwinFieldStorageCalcSumOfMultiplicationsByHead.class, storage);
        }
    }
}
