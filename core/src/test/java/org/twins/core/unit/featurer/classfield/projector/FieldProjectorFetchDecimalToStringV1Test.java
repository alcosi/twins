...
class FieldProjectorFetchDecimalToStringV1Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorFetchDecimalToStringV1 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorFetchDecimalToStringV1();
