...
class FieldProjectorStringToNumericV2Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorStringToNumericV2 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorStringToNumericV2();
