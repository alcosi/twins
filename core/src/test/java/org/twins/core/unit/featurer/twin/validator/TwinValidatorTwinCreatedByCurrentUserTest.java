...
class TwinValidatorTwinCreatedByCurrentUserTest extends BaseUnitTest {

    @Mock
    private AuthService authService;

    private TwinValidatorTwinCreatedByCurrentUser validator;

    @BeforeEach
    void setUp() throws Exception {
        validator = new TwinValidatorTwinCreatedByCurrentUser();
    ...
    class IsValid {
        ...
        @Test
        void isValid_createdByMatchesCurrentUser_returnsValid() throws Exception {
            var userId = UUID.randomUUID();
            var twin = new TwinEntity();
            twin.setId(UUID.randomUUID());
            twin.setCreatedByUserId(userId);
        ...
        @Test
        void isValid_createdByDifferentFromCurrentUser_returnsInvalid() throws Exception {
            var twin = new TwinEntity();
            twin.setId(UUID.randomUUID());
            twin.setCreatedByUserId(UUID.randomUUID());
        ...
        @Test
        void isValid_createdByNull_returnsInvalid() throws Exception {
            var twin = new TwinEntity();
            twin.setId(UUID.randomUUID());
        ...
        @Test
        void isValid_createdByMatchesCurrentUser_inverted_returnsInvalid() throws Exception {
            var userId = UUID.randomUUID();
            var twin = new TwinEntity();
            twin.setId(UUID.randomUUID());
            twin.setCreatedByUserId(userId);
