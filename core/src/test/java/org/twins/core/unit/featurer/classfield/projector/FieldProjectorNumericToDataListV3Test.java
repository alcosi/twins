...
class FieldProjectorNumericToDataListV3Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorNumericToDataListV3 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorNumericToDataListV3();
