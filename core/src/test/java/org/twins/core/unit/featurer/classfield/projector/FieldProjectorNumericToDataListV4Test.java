...
class FieldProjectorNumericToDataListV4Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorNumericToDataListV4 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorNumericToDataListV4();
