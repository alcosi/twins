...
class TwinFinderByIdEqualsCurrentUserTest extends BaseUnitTest {
    ...
    private TwinFinderByIdEqualsCurrentUser finder;

    @BeforeEach
    void setUp() throws Exception {
        finder = new TwinFinderByIdEqualsCurrentUser();
    ...
    class Concat {
        ...
        void concat_excludeFalse_addsToTwinIdList() throws ServiceException {
            ...
            assertTrue(twinSearch.getTwinIdList().contains(userId));
        }
        ...
        void concat_excludeTrue_addsToTwinIdExcludeList() throws ServiceException {
            ...
            assertTrue(twinSearch.getTwinIdExcludeList().contains(userId));
        }
    }
}
