...
class StoragerS3DynamicTest extends BaseUnitTest {
    ...
    private StoragerS3Dynamic storager;

    @BeforeEach
    void setUp() throws Exception {
        storager = new StoragerS3Dynamic();
    ...
    class GetFileControllerUri {
        ...
        void getFileControllerUri_withDomainBaseUri_prependsDomain() throws ServiceException {
            var params = buildParams();
            params.put("selfHostDomainBaseUri", "https://cdn.example.com");
            stubProperties(params);

            var result = storager.getFileControllerUri(params);

            assertEquals("https://cdn.example.com//public/static-resource/{id}/v1", result);
        }
