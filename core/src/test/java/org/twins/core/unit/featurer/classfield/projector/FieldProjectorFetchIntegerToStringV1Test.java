...
class FieldProjectorFetchIntegerToStringV1Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorFetchIntegerToStringV1 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorFetchIntegerToStringV1();
