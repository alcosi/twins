...
class FieldProjectorStringToDataListV3Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorStringToDataListV3 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorStringToDataListV3();
