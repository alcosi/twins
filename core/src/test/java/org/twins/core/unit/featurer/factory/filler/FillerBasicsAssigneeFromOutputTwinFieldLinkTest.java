...
class FillerBasicsAssigneeFromOutputTwinFieldLinkTest extends BaseUnitTest {
    ...
    class Fill {
        ...
        @Test
        void fill_firstLinkedTwin_setsAssignee() throws ServiceException {
            ...
            fieldValue.add(dstTwin); // items carry the far twins
            ...
            // NAME promises: assignee FROM the output twin's linked twin (the field's single far twin).
        ...
        @Test
        void fill_emptyLink_throwsStepError() {
