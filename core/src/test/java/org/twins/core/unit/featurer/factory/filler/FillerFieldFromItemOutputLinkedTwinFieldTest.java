...
import org.twins.core.featurer.factory.filler.FillerFieldFromItemOutputLinkedTwinField;
...
class FillerFieldFromItemOutputLinkedTwinFieldTest extends BaseUnitTest {
    ...
    private FillerFieldFromItemOutputLinkedTwinField filler;
    ...
    void setUp() throws Exception {
        filler = new FillerFieldFromItemOutputLinkedTwinField();
        ...
        when(fieldLookupers.getFromItemOutputLinkedTwinFields()).thenReturn(lookuper);
    }
    ...
    private Properties props() {
        ...
        // FillerFieldFromItemOutputLinked declares these param keys.
    ...
    class Fill {
        ...
        @Test
        void fill_resolvesOutputLinkedTwinThenLookupField() throws ServiceException {
            // NAME promises: from OUTPUT twin's linked twin (by src link field), read lookup field, write to dst.
            ...
            when(lookuper.lookupFieldValue(any(FactoryItemsBatch.class), eq(SRC_FIELD_ID), eq(LOOKUP_FIELD_ID)))
            ...
            verify(lookuper).lookupFieldValue(any(FactoryItemsBatch.class), eq(SRC_FIELD_ID), eq(LOOKUP_FIELD_ID));
