...
class WidgetAccessorDenyForKeysTest extends BaseUnitTest {

    private final WidgetAccessorDenyForKeys accessor = new WidgetAccessorDenyForKeys();

    @Nested
    class IsAvailableForClass {

        @Test
        void isAvailableForClass_classIdInList_returnsFalse() {
        ...
        @Test
        void isAvailableForClass_classIdNotInList_returnsTrue() {
            var classId = UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee");
        ...
        @Test
        void isAvailableForClass_emptyList_returnsTrue() {
            var classId = UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee");
            var twinClass = buildTwinClass(classId);
        ...
        @Test
        void isAvailableForClass_multipleIds_classInList_returnsFalse() {
        ...
        @Test
        void isAvailableForClass_multipleIds_classNotInList_returnsTrue() {
            var classId1 = UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee");
            var classId2 = UUID.fromString("11111111-2222-3333-4444-555555555555");
        ...
        @Test
        void isAvailableForClass_nullClassId_returnsTrue() {
            var classId = UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee");
