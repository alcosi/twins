...
class SluggerSystemScopeDomainManageTest extends BaseUnitTest {
    ...
    private SluggerSystemScopeDomainManage slugger;

    @BeforeEach
    void setUp() {
        slugger = new SluggerSystemScopeDomainManage();
    ...
    private UserGroupEntity buildUserGroup(UUID groupId) {
    ...
    class EnterGroup {
        ...
        @Test
        void enterGroup_domainSpecified_savesAndReturnsMapEntity() throws ServiceException {
            ...
            assertEquals(domainId, result.getDomainId());
    ...
    class ExitGroup {
        ...
        void exitGroup_entityFound_deletesAndReturnsTrue() throws ServiceException {
            ...
            when(userGroupMapRepository.findByUserIdAndUserGroupIdAndDomainId(
