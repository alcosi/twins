...
class FieldTyperCalcSumOfSubtractionsByLinkTest extends BaseUnitTest {

    @Mock
    private TwinFieldDecimalRepository twinFieldDecimalRepository;

    private FieldTyperCalcSumOfSubtractionsByLink fieldTyper;

    @BeforeEach
    void setUp() {
        fieldTyper = new FieldTyperCalcSumOfSubtractionsByLink(twinFieldDecimalRepository);
    }
    ...
    class DeserializeValue {
        ...
        void deserializeValue_returnsCachedCalculatedValueScaledAndRounded() throws ServiceException {
            ...
            twin.setTwinFieldCalculated(Map.of(classField.getId(), new BigDecimal("100")));
    ...
    class GetStorage {
        ...
        @Test
        void getStorage_returnsSumOfSubtractionsByLinkStorageWithRepositoryInjected() {
            var classField = new TwinClassFieldEntity();
            classField.setId(UUID.randomUUID());
            ...
            assertInstanceOf(TwinFieldStorageCalcSumOfSubtractionsByLink.class, storage);
        }
    }
}
