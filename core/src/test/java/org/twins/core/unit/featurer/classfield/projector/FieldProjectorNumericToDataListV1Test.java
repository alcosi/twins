...
class FieldProjectorNumericToDataListV1Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorNumericToDataListV1 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorNumericToDataListV1();
