...
class FieldProjectorStringToNumericV1Test extends BaseUnitTest {

    @Mock
    private FeaturerService featurerService;

    private FieldProjectorStringToNumericV1 projector;

    @BeforeEach
    void setUp() {
        projector = new FieldProjectorStringToNumericV1();
