...
class DataListOptionFinderSharedInHeadExcludeTwinTest extends BaseUnitTest {
    ...
    private DataListOptionFinderSharedInHeadExcludeTwin finder;
    ...
    @BeforeEach
    void setUp() {
        finder = new DataListOptionFinderSharedInHeadExcludeTwin(dataListService, twinClassFieldService, twinService);
    ...
    private Map<String, String> namedParams() {
        return Map.of(
                DataListOptionFinder.PARAM_CURRENT_TWIN_ID, twinId.toString(),
    ...
    class ConcatSearch {
        ...
        void concatSearch_populatesSearchCorrectly() throws ServiceException {
            ...
            when(twinService.findEntitySafe(twinId)).thenReturn(twinEntity());
            ...
            when(dataListService.findOptionIdsByDataListIdAndNotUsedInHeadExcludingTwin(
                    dataListId, twinClassFieldId, headTwinId, twinId
