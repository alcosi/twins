...
import org.twins.core.dto.rest.factory.FactoryEraserSearchDTOv1;
...
public class FactoryEraserSearchDTOReverseMapper extends RestSimpleDTOMapper<FactoryEraserSearchDTOv1, FactoryEraserSearch> {

    @Override
    public void map(FactoryEraserSearchDTOv1 src, FactoryEraserSearch dst, MapperContext mapperContext) {
        dst
