...
public class TwinSearchByAliasDTOReverseMapper extends RestSimpleDTOMapper<TwinSearchByAliasRqDTOv1, SearchAlias> {
    final TwinSearchWithHeadDTOReverseMapper twinSearchWithHeadDTOReverseMapper;

    @Override
    public void map(TwinSearchByAliasRqDTOv1 src, SearchAlias dst, MapperContext mapperContext) throws Exception {
        dst
