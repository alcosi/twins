...
import org.twins.core.dto.rest.permission.PermissionSearchDTOv1;
import org.twins.core.mappers.rest.RestSimpleDTOMapper;
import org.twins.core.mappers.rest.mappercontext.MapperContext;

@Component
public class PermissionSearchDTOReverseMapper extends RestSimpleDTOMapper<PermissionSearchDTOv1, PermissionSearch> {
    @Override
    public void map(PermissionSearchDTOv1 src, PermissionSearch dst, MapperContext mapperContext) {
        dst
