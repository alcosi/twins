...
import org.twins.core.dto.rest.datalist.DataListSearchDTOv1;
import org.twins.core.mappers.rest.RestSimpleDTOMapper;
import org.twins.core.mappers.rest.mappercontext.MapperContext;

@Component
@RequiredArgsConstructor
public class DataListSearchDTOReverseMapper extends RestSimpleDTOMapper<DataListSearchDTOv1, DataListSearch> {

    private final DataListOptionSearchDTOReverseMapper dataListOptionSearchDTOReverseMapper;

    @Override
    public void map(DataListSearchDTOv1 src, DataListSearch dst, MapperContext mapperContext) throws Exception {
        dst
