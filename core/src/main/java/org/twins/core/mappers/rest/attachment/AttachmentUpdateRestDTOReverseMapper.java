...
public class AttachmentUpdateRestDTOReverseMapper extends RestSimpleDTOMapper<AttachmentUpdateDTOv1, TwinAttachmentEntity> {
    ...
    @SneakyThrows
    public void preProcessAttachments(List<AttachmentUpdateDTOv1> attachments, Map<String, MultipartFile> files) {
        try {
    ...
    @SneakyThrows
    protected void processAttribute(Map<String, MultipartFile> files, AttachmentUpdateDTOv1 att) {
