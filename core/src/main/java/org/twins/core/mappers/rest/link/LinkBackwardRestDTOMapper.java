...
public class LinkBackwardRestDTOMapper extends RestSimpleDTOMapper<LinkEntity, LinkDTOv1> {
    ...
    @Override
    public void map(LinkEntity src, LinkDTOv1 dst, MapperProperties mapperProperties) throws Exception {
        dst
                .id(src.getId())
                .dstTwinClass(twinClassBaseRestDTOMapper.convert(src.getSrcTwinClass(), mapperProperties))
