...
@Component
@AllArgsConstructor
public class TransitionTriggerSearchDTOReverseMapper extends RestSimpleDTOMapper<TransitionTriggerSearchRqDTOv1, TransitionTriggerSearch> {

    @Override
    public void map(TransitionTriggerSearchRqDTOv1 src, TransitionTriggerSearch dst, MapperContext mapperContext) throws Exception {
        dst
