...
public class UserGroupInvolveAssigneeSaveDTOReverseMapper extends RestSimpleDTOMapper<UserGroupInvolveAssigneeSaveDTOv1, UserGroupInvolveAssigneeEntity> {
    @Override
