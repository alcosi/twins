...
public class I18nTranslationSearchDTOReverseMapper extends RestSimpleDTOMapper<I18nTranslationSearchDTOv1, I18nTranslationSearch> {
    @Override
    public void map(I18nTranslationSearchDTOv1 src, I18nTranslationSearch dst, MapperContext mapperContext) throws Exception {
        dst
