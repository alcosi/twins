...
public class TwinValidatorBaseV1RestDTOReverseMapper extends RestSimpleDTOMapper<TwinValidatorBaseDTOv1, TwinValidatorEntity> {

    @Override
    public void map(TwinValidatorBaseDTOv1 src, TwinValidatorEntity dst, MapperContext mapperContext) throws Exception {
        dst
                .setId(src.getId())
