...
public class SpaceRoleByGroupDTOMapper extends RestSimpleDTOMapper<SpaceRoleUserGroupEntity, SpaceRoleDTOv1> {
    final I18nService i18nService;
    @Override
    public void map(SpaceRoleUserGroupEntity src, SpaceRoleDTOv1 dst, MapperContext mapperContext) throws Exception {
