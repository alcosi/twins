...
public enum BusinessAccountMode implements MapperMode {
    ...
    @AllArgsConstructor
    @FieldNameConstants(onlyExplicitlyIncluded = true)
    public enum TwinTriggerTask2BusinessAccountMode implements MapperModePointer<BusinessAccountMode> {
        @FieldNameConstants.Include HIDE(0),
        @FieldNameConstants.Include SHORT(1),
        @FieldNameConstants.Include DETAILED(2);
    ...
    @AllArgsConstructor
    @FieldNameConstants(onlyExplicitlyIncluded = true)
    public enum DomainBusinessAccountUser2BusinessAccountMode implements MapperModePointer<BusinessAccountMode> {
        @FieldNameConstants.Include HIDE(0),
        @FieldNameConstants.Include SHORT(1),
        @FieldNameConstants.Include DETAILED(2);
