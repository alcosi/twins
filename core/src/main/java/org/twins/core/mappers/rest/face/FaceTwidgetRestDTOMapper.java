...
public class FaceTwidgetRestDTOMapper extends RestSimpleDTOMapper<TwidgetConfig<? extends FaceTwidgetEntity>, FaceTwidgetDTOv1> {
    ...
    @Override
    public void map(TwidgetConfig<? extends FaceTwidgetEntity> src, FaceTwidgetDTOv1 dst, MapperContext mapperContext) throws Exception {
    ...
    @Override
    public void beforeCollectionConversion(Collection<TwidgetConfig<? extends FaceTwidgetEntity>> srcCollection, MapperContext mapperContext) throws Exception {
