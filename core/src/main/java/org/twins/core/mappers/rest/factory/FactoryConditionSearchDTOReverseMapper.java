...
import org.twins.core.dto.rest.factory.FactoryConditionSearchDTOv1;
import org.twins.core.mappers.rest.RestSimpleDTOMapper;
import org.twins.core.mappers.rest.mappercontext.MapperContext;

@Component
@RequiredArgsConstructor
public class FactoryConditionSearchDTOReverseMapper extends RestSimpleDTOMapper<FactoryConditionSearchDTOv1, FactoryConditionSearch> {

    @Override
    public void map(FactoryConditionSearchDTOv1 src, FactoryConditionSearch dst, MapperContext mapperContext) {
        dst
