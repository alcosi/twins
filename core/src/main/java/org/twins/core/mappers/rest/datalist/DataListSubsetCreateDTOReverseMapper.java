...
public class DataListSubsetCreateDTOReverseMapper extends RestSimpleDTOMapper<DataListSubsetCreateDTOv1, DataListSubsetEntity> {
    private final DataListSubsetSaveDTOReverseMapper dataListSubsetSaveDTOReverseMapper;

    @Override
    public void map(DataListSubsetCreateDTOv1 src, DataListSubsetEntity dst, MapperContext mapperContext) throws Exception {
