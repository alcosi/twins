...
import org.twins.core.dto.rest.attachment.AttachmentSearchDTOv1;
...
@Component
@AllArgsConstructor
public class AttachmentSearchDTOv1ReverseMapper extends RestSimpleDTOMapper<AttachmentSearchDTOv1, AttachmentSearch> {
    ...
    @Override
    public void map(AttachmentSearchDTOv1 src, AttachmentSearch dst, MapperContext mapperContext) throws Exception {
        dst
