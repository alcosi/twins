...
public class I18nRestDTOReverseMapper extends RestSimpleDTOMapper<I18nSaveDTOv1, I18nTranslation> {
    final AuthService authService;
    @Override
    public void map(I18nSaveDTOv1 src, I18nTranslation dst, MapperContext mapperContext) throws Exception {
