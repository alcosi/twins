...
import org.twins.core.dto.rest.factory.FactoryBranchSearchDTOv1;
import org.twins.core.mappers.rest.RestSimpleDTOMapper;
import org.twins.core.mappers.rest.mappercontext.MapperContext;

@Component
@RequiredArgsConstructor
public class FactoryBranchSearchDTOReverseMapper extends RestSimpleDTOMapper<FactoryBranchSearchDTOv1, FactoryBranchSearch> {

    @Override
    public void map(FactoryBranchSearchDTOv1 src, FactoryBranchSearch dst, MapperContext mapperContext) {
        dst
