...
import org.twins.core.dto.rest.link.LinkSearchDTOv1;
import org.twins.core.mappers.rest.RestSimpleDTOMapper;
import org.twins.core.mappers.rest.mappercontext.MapperContext;

@Component
@RequiredArgsConstructor
public class LinkSearchDTOReverseMapper extends RestSimpleDTOMapper<LinkSearchDTOv1, LinkSearch> {

    @Override
    public void map(LinkSearchDTOv1 src, LinkSearch dst, MapperContext mapperContext) {
        dst
