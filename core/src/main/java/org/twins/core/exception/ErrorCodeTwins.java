...
public enum ErrorCodeTwins implements ErrorCode {
    ...
    PERMISSION_ID_IS_NOT_CORRECT(10305, "Permission with the current permission group id cannot be created"),
    PERMISSION_ID_NOT_BE_NULL(10305, "Permission id cannot be null"),
    ...
    LINK_DIRECTION_CLASS_NULL(12001, "Src or dst class of link cannot be null. Dont send nullify marker"),
    LINK_UPDATE_RESTRICTED(12002, "link can not be updated"),
