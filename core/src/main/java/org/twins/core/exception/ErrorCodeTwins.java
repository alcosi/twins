...
public enum ErrorCodeTwins implements ErrorCode {
    ...
    TWIN_CLASS_FIELD_COUNTER_IS_INCOMPATIBLE(10434, "twin class field counter is incompatible with field typer"),
    ...
    TWIN_ACTION_ACCESS_DENIED(11803, "twin action forbidden by current user", HttpStatus.FORBIDDEN),
