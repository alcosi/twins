...
public enum I18nType  {
    ...
    TWIN_CLASS_AVAILABILITY_NAME("twinClassAvailabilityName", "Twin class availability name", Category.TEXT),
    TWIN_CLASS_AVAILABILITY_DESCRIPTION("twinClassAvailabilityDescription", "Twin class availability description", Category.TEXT),
