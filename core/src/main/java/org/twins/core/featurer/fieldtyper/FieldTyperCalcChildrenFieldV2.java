...
Save sum of child.fields.values on serializeValue, and return saved total from database
                              """)
public class FieldTyperCalcChildrenFieldV2 extends FieldTyperSimple<FieldDescriptorText, FieldValueText, TwinFieldSearch> implements FieldTyperCalcChildrenField {
