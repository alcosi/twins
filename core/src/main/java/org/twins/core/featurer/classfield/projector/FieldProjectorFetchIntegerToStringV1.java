...
@Slf4j
@Component
@Featurer(id = FeaturerTwins.ID_4413,
        name = "Field projection fetch integer to string v1",
        description = "")
public class FieldProjectorFetchIntegerToStringV1 extends FieldProjector {
