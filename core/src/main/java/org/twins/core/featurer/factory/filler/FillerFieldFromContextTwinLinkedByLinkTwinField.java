...
@Component
@Featurer(id = FeaturerTwins.ID_2347,
...
public class FillerFieldFromContextTwinLinkedByLinkTwinField extends FillerFieldLookupLinked {
    ...
    @FeaturerParam(name = "Src twin class field id", description = "", order = 2)
    ...
    @FeaturerParam(name = "Field lookuper", description = "Source of the field value", order = 99, optional = true, defaultValue = "fromContextTwinLinkedByLinkTwinFields")
