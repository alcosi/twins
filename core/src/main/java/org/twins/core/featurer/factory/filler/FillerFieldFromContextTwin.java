...
@Component
@Featurer(id = 2311,
        name = "FillerFieldFromContextTwin",
        description = "")
@Slf4j
public class FillerFieldFromContextTwin extends Filler {
    ...
    public void fill(Properties properties, FactoryItem factoryItem, TwinEntity templateTwin) throws ServiceException {
        ...
        if (srcField != null) {
            log.warn("TwinClassField[" + srcTwinClassFieldId.extract(properties) + "] is not present for context " + contextTwin);
            return;
        }
        ...
        try {
            ...
            log.info(outputTwinEntity + "" + dstTwinClassField + " will be filled from context twin " + srcField);
        } catch (Exception e) {
