...
public class FieldTyperCountChildrenTwinsByTwinClassV1 extends FieldTyper<FieldDescriptorText, FieldValueText, TwinFieldStorageSpirit, TwinFieldSearchNotImplemented> implements FieldTyperCountChildrenByTwinClass {
    @Autowired
