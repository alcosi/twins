...
/**
 * Compares this field's date with another date field of the same twin.
 * Preloads twin field values once per batch; per-item compare is in-memory.
 */
@Slf4j
@Component
...
public class FieldValidatorDateCompare extends FieldValidatorAtomic {
