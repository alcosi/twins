...
@Slf4j
@Component
@Featurer(id = FeaturerTwins.ID_4414,
        name = "Field projection fetch decimal to string v1",
        description = "")
public class FieldProjectorFetchDecimalToStringV1 extends FieldProjector {
