...
@Featurer(id = FeaturerTwins.ID_2702,
        name = "By assignee user id (given)",
        description = "")
public class TwinFinderByAssigneeUserIdGiven extends TwinFinder {
    ...
    public void concat(TwinSearch twinSearch, Properties properties, Map<String, String> namedParamsMap) throws ServiceException {
        twinSearch.addAssigneeUserId(userIds.extract(properties), exclude.extract(properties));
    }
}
