...
public class TwinTriggerChangeStatusByTwoLinksForward extends TwinTrigger {
    ...
    public void run(Properties properties, TwinEntity twinEntity, TwinStatusEntity srcTwinStatus, TwinStatusEntity dstTwinStatus) throws ServiceException {
        log.warn("ChangeStatusByTwoLinksForward: START - twinId={}, class={}",
        ...
        log.warn("ChangeStatusByTwoLinksForward: params - firstLinkId={}, secondLinkId={}, classId={}, dstStatusId={}",
        ...
        if (firstLinkIdValue == null || secondLinkIdValue == null || dstStatusIdValue == null) {
            log.warn("ChangeStatusByTwoLinksForward: missing required parameters");
            return;
        }
        ...
        log.warn("ChangeStatusByTwoLinksForward: updated {} target twins", updated);
    }
}
