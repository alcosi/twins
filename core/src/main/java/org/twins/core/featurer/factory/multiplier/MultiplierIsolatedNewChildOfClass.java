...
@Component
@Featurer(id = FeaturerTwins.ID_2216,
        name = "Isolated",
        description = "New child output twin for each input. Output class from params. Head = input")
public class MultiplierIsolatedNewChildOfClass extends Multiplier {
