...
@Featurer(id = FeaturerTwins.ID_2707,
        name = "By created by user id (given)",
        description = "")
public class TwinFinderByCreatedByUserIdGiven extends TwinFinder {
    ...
    public void concat(TwinSearch twinSearch, Properties properties, Map<String, String> namedParamsMap) throws ServiceException {
        twinSearch.addCreatedByUserId(userIds.extract(properties), exclude.extract(properties));
    }
}
