...
@Component
@Featurer(id = FeaturerTwins.ID_2438,
        name = "Factory item twin has children of classes",
        description = "")
@Slf4j
public class ConditionerFactoryItemTwinHasChildrenOfClasses extends Conditioner {
    ...
    public boolean check(Properties properties, FactoryItem factoryItem) throws ServiceException {
        ...
        search
                ...
                .addTwinClassExtendsHierarchyContainsId(classIds.extract(properties));
