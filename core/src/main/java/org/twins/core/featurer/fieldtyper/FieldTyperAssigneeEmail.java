...
public class FieldTyperAssigneeEmail extends FieldTyperImmutable<FieldDescriptorImmutable, FieldValueText, TwinFieldStorageTwin, TwinFieldSearchNotImplemented> {
