...
@Featurer(id = FeaturerTwins.ID_2704,
        name = "By class id (given)",
        description = "")
public class TwinFinderByClassIdGiven extends TwinFinder {
    @FeaturerParam(name = "Class ids", description = "", order = 1)
    public static final FeaturerParamUUIDSet classIds = new FeaturerParamUUIDSetTwinsTwinId("classIds");
    ...
    public void concat(TwinSearch twinSearch, Properties properties, Map<String, String> namedParamsMap) throws ServiceException {
        twinSearch.addTwinClassId(classIds.extract(properties), exclude.extract(properties));
    }
}
