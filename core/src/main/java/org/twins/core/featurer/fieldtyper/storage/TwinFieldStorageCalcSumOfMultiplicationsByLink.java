...
public class TwinFieldStorageCalcSumOfMultiplicationsByLink extends TwinFieldStorageCalc {
    ...
    public TwinFieldStorageCalcSumOfMultiplicationsByLink(UUID twinClassFieldId, TwinFieldSimpleRepository twinFieldSimpleRepository, UUID firstFieldId, UUID secondFieldId, UUID linkId, boolean srcElseDst, Set<UUID> linkedTwinInStatusIdList, Set<UUID> linkedTwinOfClassIds, boolean statusExclude) {
    ...
    public void load(Kit<TwinEntity, UUID> twinsKit) throws ServiceException {
        List<TwinFieldCalcProjection> calc = twinFieldSimpleRepository.sumLinkedTwinFieldValuesOfMultiplicationsByLink(
                twinsKit.getIdSet(),
                srcElseDst,
