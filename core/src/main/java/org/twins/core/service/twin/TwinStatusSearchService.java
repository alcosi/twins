...
public class TwinStatusSearchService {
    ...
    private Specification<TwinStatusEntity> createTwinStatusSearchSpecification(TwinStatusSearch search) throws ServiceException {
        ...
        return Specification.allOf(
                ...
                checkUuidIn(twinClassService.loadExtendedClasses(search.getTwinClassIdsExtenderList()), false, true, TwinStatusEntity.Fields.twinClassId),
                checkUuidIn(twinClassService.loadExtendedClasses(search.getTwinClassIdsExtenderExcludeList()), true, true, TwinStatusEntity.Fields.twinClassId),
