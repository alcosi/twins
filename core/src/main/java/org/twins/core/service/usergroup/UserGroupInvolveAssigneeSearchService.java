...
public class UserGroupInvolveAssigneeSearchService {
    ...
    public PaginationResult<UserGroupInvolveAssigneeEntity> findPermissionAssigneePropagations(UserGroupInvolveAssigneeSearch search, SimplePagination pagination) throws ServiceException {
