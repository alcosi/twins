...
public class DataListSearchService {
    ...
    private Specification<DataListEntity> createDataListSpecification(DataListSearch search) throws ServiceException {
        ...
        return Specification.allOf(
                ...
                doubleJoinAndSearchByI18NFieldDirect(DataListEntity.Fields.dataListOptions, DataListOptionEntity.Fields.optionI18nTranslationsSpecOnly, search.getOptionSearch() != null ? search.getOptionSearch().getOptionI18nLikeList() : null, apiUser.getLocale(), false, false),
                doubleJoinAndSearchByI18NFieldDirect(DataListEntity.Fields.dataListOptions, DataListOptionEntity.Fields.optionI18nTranslationsSpecOnly, search.getOptionSearch() != null ? search.getOptionSearch().getOptionI18nNotLikeList() : null, apiUser.getLocale(), true, true),
