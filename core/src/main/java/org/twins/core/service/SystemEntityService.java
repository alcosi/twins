...
public class SystemEntityService {
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_NAME = UUID.fromString("00000000-0000-0000-0012-000000000012");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_NAME = UUID.fromString("00000000-0000-0000-0012-000000000013");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_NAME = UUID.fromString("00000000-0000-0000-0012-000000000014");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_NAME = UUID.fromString("00000000-0000-0000-0012-000000000015");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_NAME = UUID.fromString("00000000-0000-0000-0012-000000000016");
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000022");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000022");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000022");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000022");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000022");
        ...
        SYSTEM_CLASSES = Collections.unmodifiableList(Arrays.asList(
                ...
                new SystemClass(
                        ...
                        List.of(
                                ...
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_NAME, "Id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_DESCRIPTION, "Twin id"), "base_id", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_TWIN_CLASS_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_NAME, "Twin class id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_DESCRIPTION, "Twin class id"), "base_twin_class_id", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ALIASES, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_NAME, "Aliases"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_DESCRIPTION, "Aliases"), "base_aliases", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_TAGS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_NAME, "Tags"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_DESCRIPTION, "Tags"), "base_tags", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_MARKERS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_NAME, "Markers"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_DESCRIPTION, "Markers"), "base_markers", false)
                        ),
                        true,
                        false
                )
