...
public class SystemEntityService {
    ...
    public static final UUID TWIN_CLASS_FIELD_TWIN_ATTACHMENT = UUID.fromString("00000000-0000-0000-0011-000000000017");
    public static final UUID TWIN_CLASS_FIELD_TWIN_ATTACHMENT_TRANSITION = UUID.fromString("00000000-0000-0000-0011-000000000018");
    public static final UUID TWIN_CLASS_FIELD_TWIN_ATTACHMENT_ALL_FIELDS = UUID.fromString("00000000-0000-0000-0011-000000000019");
    public static final UUID TWIN_CLASS_FIELD_TWIN_ATTACHMENT_COMMENT = UUID.fromString("00000000-0000-0000-0011-000000000020");
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_NAME = UUID.fromString("00000000-0000-0000-0012-000000000037");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_TRANSITION_NAME = UUID.fromString("00000000-0000-0000-0012-000000000038");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_ALL_FIELDS_NAME = UUID.fromString("00000000-0000-0000-0012-000000000039");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_COMMENT_NAME = UUID.fromString("00000000-0000-0000-0012-000000000040");
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000041");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_TRANSITION_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000042");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_ALL_FIELDS_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000043");
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_COMMENT_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000044");
        ...
        SYSTEM_CLASSES = Collections.unmodifiableList(Arrays.asList(
                ...
                new SystemClass(
                        ...
                        List.of(
                                ...
                                new SystemField(TWIN_CLASS_FIELD_TWIN_OWNER_USER, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1322, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_OWNER_USER_NAME, "Owner"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_OWNER_USER_DESCRIPTION, "Twin owner"), "base_owner_user", false),
                                ...
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1327, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_NAME, "Id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_DESCRIPTION, "Twin id"), "base_id", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_TWIN_CLASS_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1328, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_NAME, "Twin class id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_DESCRIPTION, "Twin class id"), "base_twin_class_id", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ALIASES, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1329, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_NAME, "Aliases"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ALIASES_DESCRIPTION, "Aliases"), "base_aliases", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_TAGS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1330, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_NAME, "Tags"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TAGS_DESCRIPTION, "Tags"), "base_tags", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_MARKERS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1331, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_NAME, "Markers"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_MARKERS_DESCRIPTION, "Markers"), "base_markers", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ATTACHMENT, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1333, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_NAME, "Twin attachment"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_DESCRIPTION, "Twin attachment"), "base_twin_attachment", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ATTACHMENT_TRANSITION, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1333, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_TRANSITION_NAME, "Twinflow transition attachment"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_TRANSITION_DESCRIPTION, "Twinflow transition attachment"), "base_twinflow_transition_attachment", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ATTACHMENT_ALL_FIELDS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1333, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_ALL_FIELDS_NAME, "Twin all fields attachment"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_ALL_FIELDS_DESCRIPTION, "Twin all fields attachment"), "base_twin_all_fields_attachment", false),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ATTACHMENT_COMMENT, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1333, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_COMMENT_NAME, "Twin comment attachment"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_COMMENT_DESCRIPTION, "Twin comment attachment"), "base_twin_comment_attachment", false)
                                ),
                        true,
                        false
                )
