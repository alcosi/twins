...
public class SystemEntityService {
    ...
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_PURPOSE            = UUID.fromString("00000000-0000-0000-0011-000000000050");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_FIELDS             = UUID.fromString("00000000-0000-0000-0011-000000000051");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_RELATIONS_OVERVIEW = UUID.fromString("00000000-0000-0000-0011-000000000052");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_API                = UUID.fromString("00000000-0000-0000-0011-000000000053");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_API_DEPRECATED     = UUID.fromString("00000000-0000-0000-0011-000000000054");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_EXAMPLES           = UUID.fromString("00000000-0000-0000-0011-000000000055");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_DEV_NOTES          = UUID.fromString("00000000-0000-0000-0011-000000000056");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_JPA_CLASS          = UUID.fromString("00000000-0000-0000-0011-000000000057");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_DB_TABLE           = UUID.fromString("00000000-0000-0000-0011-000000000058");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_MARKDOWN_SOURCE    = UUID.fromString("00000000-0000-0000-0011-000000000059");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_MARKDOWN_HASH      = UUID.fromString("00000000-0000-0000-0011-000000000060");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_IS_SYSTEM          = UUID.fromString("00000000-0000-0000-0011-000000000061");
    public static final UUID TWIN_CLASS_FIELD_GLOSSARY_ACTUALIZED_AT      = UUID.fromString("00000000-0000-0000-0011-000000000062");
