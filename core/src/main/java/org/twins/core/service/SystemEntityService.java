...
public class SystemEntityService {
    ...
    public static final UUID TWIN_CLASS_FIELD_TWIN_ATTACHMENT_FIELD = UUID.fromString("00000000-0000-0000-0011-000000000019");
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_FIELD_NAME = UUID.fromString("00000000-0000-0000-0012-000000000039");
    ...
    public static final UUID I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_FIELD_DESCRIPTION = UUID.fromString("00000000-0000-0000-0012-000000000043");
        ...
        SYSTEM_CLASSES = Collections.unmodifiableList(Arrays.asList(
                ...
                new SystemClass(
                        ...
                        List.of(
                                ...
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ATTACHMENT_FIELD, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1333, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_FIELD_NAME, "Twin field attachment"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_ATTACHMENT_FIELD_DESCRIPTION, "Twin field attachment"), "base_twin_field_attachment", false),
