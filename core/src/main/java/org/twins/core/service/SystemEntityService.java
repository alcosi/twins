    ...
    static {
        SYSTEM_CLASSES = Collections.unmodifiableList(Arrays.asList(
                ...
                new SystemClass(
                        ...
                        List.of(
                                new SystemField(TWIN_CLASS_FIELD_TWIN_NAME, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1321, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_NAME_NAME, "Name"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_NAME_DESCRIPTION, "Twin name"), 4101,"base_name", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_DESCRIPTION, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1321, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_DESCRIPTION_NAME, "Description"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_DESCRIPTION_DESCRIPTION, "Twin description"), 4101,"base_description", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_EXTERNAL_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1321, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_EXTERNAL_ID_NAME, "External ID"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_EXTERNAL_ID_DESCRIPTION, "External identifier"), 4101,"base_external_id", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_OWNER_USER, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1322, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_OWNER_USER_NAME, "Owner"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_OWNER_USER_DESCRIPTION, "Twin owner"), 4101,"base_owner_user", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ASSIGNEE_USER, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1322, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ASSIGNEE_NAME, "Assignee"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ASSIGNEE_USER_DESCRIPTION, "Assigned user"), 4101,"base_assignee_user", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_CREATOR_USER, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1322, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_CREATOR_NAME, "Creator"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_CREATOR_USER_DESCRIPTION, "User who created the twin"), 4101,"base_creator_user", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_HEAD, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1323, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_HEAD_NAME, "Head"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_HEAD_DESCRIPTION, "Head twin"), 4101,"base_head", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_STATUS, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1324, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_STATUS_NAME, "Status"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_STATUS_DESCRIPTION, "Twin status"), 4101,"base_status", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_CREATED_AT, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1325, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_CREATED_AT_NAME, "Created At"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_CREATED_AT_DESCRIPTION, "Creation timestamp"), 4101,"base_created_at", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1327, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_NAME, "Id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_ID_DESCRIPTION, "Twin id"), 4101,"base_id", false, true),
                                new SystemField(TWIN_CLASS_FIELD_TWIN_TWIN_CLASS_ID, TWIN_CLASS_GLOBAL_ANCESTOR, FeaturerTwins.ID_1328, new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_NAME, "Twin class id"), new I18n(I18N_4CLASS_GLOBAL_ANCESTOR_FIELD_TWIN_CLASS_ID_DESCRIPTION, "Twin class id"), 4101,"base_twin_class_id", false, true),
