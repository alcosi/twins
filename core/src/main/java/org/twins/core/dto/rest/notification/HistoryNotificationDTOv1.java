...
public class HistoryNotificationDTOv1 {
    ...
    @RelatedObject(type = HistoryNotificationDTOv1.class, name = "twinClass")
    public UUID twinClassId;

    @Schema(description = "twin class field id", example = DTOExamples.TWIN_CLASS_FIELD_ID)
    @RelatedObject(type = HistoryNotificationDTOv1.class, name = "twinClassField")
    public UUID twinClassFieldId;

    @Schema(description = "twin validator set id")
    @RelatedObject(type = HistoryNotificationDTOv1.class, name = "twinValidatorSet")
    ...
    @RelatedObject(type = HistoryNotificationDTOv1.class, name = "notificationSchema")
    public UUID notificationSchemaId;

    @Schema(description = "history notification recipient id")
    @RelatedObject(type = HistoryNotificationDTOv1.class, name = "historyNotificationRecipient")
