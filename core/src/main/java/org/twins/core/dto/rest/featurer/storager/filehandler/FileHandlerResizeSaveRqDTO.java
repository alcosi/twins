...
import org.twins.core.featurer.storager.filehandler.StoragerAlcosiFileHandler;
...
public record FileHandlerResizeSaveRqDTO(String id, String fileName, String type, byte[] fileBytes, List<ResizeTaskDTO> tasks,
                                         StoragerAlcosiFileHandler.StorageType storageType, String storageDir, boolean saveOriginal) {}
