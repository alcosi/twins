...
@Schema(name = "FactoryMultiplierFilterCountRqV1")
public class FactoryMultiplierFilterCountRqDTOv1 extends Request {
    ...
    public Set<FactoryMultiplierFilterGroupField> groupFields;
}
