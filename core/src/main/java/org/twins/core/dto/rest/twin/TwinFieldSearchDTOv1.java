...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = TwinFieldLastChangeSearchBeforeDTOv1.class, name = TwinFieldLastChangeSearchBeforeDTOv1.KEY),
})
@Schema(
        ...
        oneOf = {
                ...
                TwinFieldLastChangeSearchBeforeDTOv1.class,
        }
)
