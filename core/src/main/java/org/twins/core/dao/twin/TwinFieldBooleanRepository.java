...
@Repository
public interface TwinFieldBooleanRepository extends TwinFieldRepository<TwinFieldBooleanEntity> {
    ...
    @Query(value = """
            ...
            from TwinFieldBooleanEntity field where field.twinSpecOnly.twinClassId = :twinClassId and field.twinClassFieldId in (:twinClassFields)
            """)
    ...
    @Transactional
    @Modifying
    @Query(value = "update TwinFieldBooleanEntity set twinClassFieldId = :toTwinClassFieldId where twinClassFieldId = :fromTwinClassFieldId and twinSpecOnly.twinClassId = :twinClassId")
