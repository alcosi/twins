...
@Repository
public interface TwinFieldUserRepository extends TwinFieldRepository<TwinFieldUserEntity> {
    ...
    @Query(value = """
            ...
            from TwinFieldUserEntity field where field.twinSpecOnly.twinClassId = :twinClassId and field.twinClassFieldId in (:twinClassFields)
            """)
    ...
    @Transactional
    @Modifying
    @Query(value = "update TwinFieldUserEntity set twinClassFieldId = :toTwinClassFieldId where twinClassFieldId = :fromTwinClassFieldId and twinSpecOnly.twinClassId = :twinClassId")
