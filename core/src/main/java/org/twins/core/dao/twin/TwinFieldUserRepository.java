...
public interface TwinFieldUserRepository extends CrudRepository<TwinFieldUserEntity, UUID>, JpaSpecificationExecutor<TwinFieldUserEntity> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update TwinFieldUserEntity set twinClassFieldId = :toTwinClassFieldId where twinClassFieldId = :fromTwinClassFieldId and twin.twinClassId = :twinClassId")
