...
public class DraftEntity implements EasyLoggable {
    ...
    public enum Status {
        ...
        ERASE_SCOPE_COLLECT_PLANNED("ERASE_SCOPE_COLLECT_PLANNED"),
        ERASE_SCOPE_COLLECT_NEED_START("ERASE_SCOPE_COLLECT_NEED_START"),
        ERASE_SCOPE_COLLECT_IN_PROGRESS("ERASE_SCOPE_COLLECT_IN_PROGRESS"),
        ERASE_SCOPE_COLLECT_EXCEPTION("ERASE_SCOPE_COLLECT_EXCEPTION"),
        CONSTRUCTION_EXCEPTION("CONSTRUCTION_EXCEPTION"),
        NORMALIZE_EXCEPTION("NORMALIZE_EXCEPTION"),
        CHECK_CONFLICTS_EXCEPTION("CHECK_CONFLICTS_EXCEPTION"),
