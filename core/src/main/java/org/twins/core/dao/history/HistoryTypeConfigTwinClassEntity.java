...
@Table(name = "history_type_config_twin_class")
public class HistoryTypeConfigTwinClassEntity implements EasyLoggable, HistoryTypeConfigLevel {
    @Id
...
//    private HistoryTypeEntity historyTypeEntity;
    ...
    public String easyLog(Level level) {
        switch (level) {
            case SHORT:
                return "historyTypeConfigTwinClass[" + id + "]";
            default:
                return "historyTypeConfigTwinClass[id:" + id + ", historyType:" + historyType + ", twinClassId:" + twinClassId + ", status:" + status + "]";
        }
    }
}
