...
public interface UserGroupMapType1Repository extends CrudRepository<UserGroupMapType1Entity, UUID>, JpaSpecificationExecutor<UserGroupMapType1Entity> {
    ...
    List<UserGroupMapType1Entity> findByUserIdAndUserGroup_BusinessAccountIdAndUserGroup_DomainId(UUID userId, UUID businessAccountId, UUID domainId);
    List<UserGroupMapType1Entity> findByUserIdAndUserGroup_BusinessAccountId(UUID userId, UUID businessAccountId);
    List<UserGroupMapType1Entity> findByUserIdAndUserGroup_DomainId(UUID userId, UUID domainId);
}
