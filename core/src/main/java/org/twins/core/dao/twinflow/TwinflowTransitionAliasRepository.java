...
public interface TwinflowTransitionAliasRepository extends CrudRepository<TwinflowTransitionAliasEntity, UUID>, JpaSpecificationExecutor<TwinflowTransitionAliasEntity> {
