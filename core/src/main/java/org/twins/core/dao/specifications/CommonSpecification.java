...
public class CommonSpecification<T> {
    ...
    public static <T> Specification<T> checkFieldStringLike(String fieldValue, String... filedPath) {
        return (root, query, cb) -> createPredicateWithJoins(root, cb, fieldValue, (property, criteriaBuilder, filedValue) -> criteriaBuilder.like(property, filedValue), filedPath);
    }
    /**
    ...
    public static <T> Specification<T> checkFieldUuid(UUID fieldValue, String... filedPath) {
        return (root, query, cb) -> createPredicateWithJoins(root, cb, fieldValue, (property, criteriaBuilder, filedValue) -> criteriaBuilder.equal(property, filedValue), filedPath);
    }
