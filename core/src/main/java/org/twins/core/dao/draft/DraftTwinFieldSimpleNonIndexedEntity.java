...
@Entity
@Table(name = "draft_twin_field_simple_non_indexed")
public class DraftTwinFieldSimpleNonIndexedEntity {
    @Id
    ...
    @Column(name = "twin_field_simple_non_indexed_id")
    private UUID twinFieldSimpleNonIndexedId;
