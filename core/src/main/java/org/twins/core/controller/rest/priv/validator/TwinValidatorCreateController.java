...
import org.twins.core.mappers.rest.validator.TwinValidatorCreateRestDTOReverseMapper;
...
public class TwinValidatorCreateController extends ApiController {
    ...
    private final TwinValidatorCreateRestDTOReverseMapper twinValidatorCreateRestDTOReverseMapper;
    private final TwinValidatorRestDTOMapper twinValidatorRestDTOMapper;
    private final RelatedObjectsRestDTOConverter relatedObjectsRestDTOConverter;

    @ParametersApiUserHeaders
    @Operation(operationId = "twinValidatorCreateV1", summary = "Twin validator batch create")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Twin validator batch create", content = {
    ...
    public ResponseEntity<?> twinValidatorCreateV1(
        ...
        try {
            ...
            Collection<TwinValidatorEntity> twinValidatorEntityList = twinValidatorService.createTwinValidators(createList);
            rs
