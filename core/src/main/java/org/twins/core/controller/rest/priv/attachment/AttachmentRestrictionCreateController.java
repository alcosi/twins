...
import org.twins.core.dto.rest.attachment.AttachmentRestrictionCreateRqDTOv1;
import org.twins.core.dto.rest.attachment.AttachmentRestrictionListRsDTOv1;
import org.twins.core.mappers.rest.attachment.AttachmentRestrictionCreateDTOReverseMapper;
...
@ProtectedBy(Permissions.ATTACHMENT_RESTRICTION_CREATE)
public class AttachmentRestrictionCreateController extends ApiController {
    private final RelatedObjectsRestDTOConverter relatedObjectsRestDTOConverter;
    private final AttachmentRestrictionCreateDTOReverseMapper attachmentRestrictionCreateDTOReverseMapper;
    ...
    @Operation(operationId = "attachmentRestrictionCreateV1", summary = "Attachment restriction create")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Attachment restrictions created", content = {
