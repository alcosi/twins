...
import org.twins.core.dto.rest.twinclass.TwinClassFieldConditionUpdateRqDTOv1;
...
@ProtectedBy(Permissions.TWIN_CLASS_FIELD_RULE_UPDATE)
public class TwinClassFieldConditionUpdateController extends ApiController {

    private final RelatedObjectsRestDTOConverter relatedObjectsRestDTOConverter;
    private final TwinClassFieldConditionUpdateRestDTOReverseMapper twinClassFieldConditionUpdateRestDTOReverseMapper;
    ...
    @Operation(operationId = "twinClassFieldConditionUpdateV1", summary = "Update twin class field conditions")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Conditions successfully updated", content = {
    ...
    public ResponseEntity<?> twinClassFieldConditionUpdateV1(
        ...
        try {
            List<TwinClassFieldConditionEntity> conditionEntities = twinClassFieldConditionService.updateConditions(
                    twinClassFieldConditionUpdateRestDTOReverseMapper.convertCollection(request.getConditions(), mapperContext));
            rs
