...
public class TwinListController extends ApiController {
    ...
    public ResponseEntity<?> twinSearchV1(
        ...
        try {
            PaginationResult<TwinEntity> twins = twinSearchService.findTwins(twinSearchWithHeadDTOReverseMapper.convert(request), PaginationUtils.createSimplePagination(offset, limit, sort(false, TwinEntity.Fields.createdAt)));
            ...
            rs
                    .setTwinList(twinRestDTOMapper.convertList(twins.getList(), mapperContext))
    ...
    public ResponseEntity<?> twinSearchV2(
        ...
        try {
            ...
            MapperContext mapperContext = new MapperContext()
                    ...
                    .setMode(showTwinActionMode);
            rs
                    .setTwinList(twinRestDTOMapperV2.convertList(twins.getList(), mapperContext))
                    .setPagination(paginationMapper.convert(twins))
                    .setRelatedObjects(relatedObjectsRestDTOMapper.convert(mapperContext));
        } catch (ServiceException se) {
            return createErrorRs(se, rs);
    ...
    public ResponseEntity<?> twinSearchV3(
        ...
        try {
            ...
            PaginationResult<TwinEntity> twins = twinSearchService.findTwins(basicSearches, PaginationUtils.createSimplePagination(offset, limit, sort(false, TwinEntity.Fields.createdAt)));
            MapperContext mapperContext = new MapperContext()
                    .setLazyRelations(lazyRelation)
                    .setMode(showRelatedByHeadTwinMode)
                    .setMode(showRelatedByLinkTwinMode)
    ...
    public ResponseEntity<?> twinSearchByAliasV1(
        ...
        TwinSearchRsDTOv2 rs = new TwinSearchRsDTOv2();
        try {
            PaginationResult<TwinEntity> twins = twinSearchService.findTwins(twinSearchByAliasDTOReverseMapper.convert(request), PaginationUtils.createSimplePagination(offset, limit, sort(false, TwinEntity.Fields.createdAt)));
            MapperContext mapperContext = new MapperContext()
                    .setLazyRelations(lazyRelation)
                    .setMode(showRelatedByHeadTwinMode)
                    .setMode(showRelatedByLinkTwinMode)
    ...
    public ResponseEntity<?> twinSearchByIdV1(
        ...
        TwinSearchRsDTOv2 rs = new TwinSearchRsDTOv2();
        try {
            PaginationResult<TwinEntity> twins = twinSearchService.findTwins(searchId, request.getParams(), twinSearchWithHeadDTOReverseMapper.convert(request.getNarrow()), PaginationUtils.createSimplePagination(offset, limit, sort(false, TwinEntity.Fields.createdAt)));
            MapperContext mapperContext = new MapperContext()
                    .setLazyRelations(lazyRelation)
                    .setMode(showRelatedByHeadTwinMode)
                    .setMode(showRelatedByLinkTwinMode)
