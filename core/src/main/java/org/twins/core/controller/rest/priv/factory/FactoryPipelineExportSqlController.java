...
public class FactoryPipelineExportSqlController extends ApiController {
    private final FactoryPipelineExportService pipelineExportService;

    @ParametersApiUserHeaders
    @Operation(operationId = "factoryPipelineExportSqlV1", summary = "Exports factory pipelines as SQL INSERT statements")
    @ApiResponses(value = {
