...
public class TwinClassListController extends ApiController {
    ...
    public ResponseEntity<?> twinClassSearchV1(
            ...
            @Parameter(name = "showTwinClassFieldMode", in = ParameterIn.QUERY) @RequestParam(defaultValue = TwinClassFieldRestDTOMapper.Mode._NONE) TwinClassFieldRestDTOMapper.Mode showTwinClassFieldMode,
    ...
    public ResponseEntity<?> twinClassListV1(
            @Parameter(name = "showTwinClassMode", in = ParameterIn.QUERY) @RequestParam(defaultValue = TwinClassRestDTOMapper.Mode._ID_ONLY) TwinClassRestDTOMapper.Mode showTwinClassMode,
            @Parameter(name = "showTwinClassFieldMode", in = ParameterIn.QUERY) @RequestParam(defaultValue = TwinClassFieldRestDTOMapper.Mode._NONE) TwinClassFieldRestDTOMapper.Mode showTwinClassFieldMode,
            @Parameter(name = "showSpacesMode", in = ParameterIn.QUERY) @RequestParam(defaultValue = TwinRestDTOMapper.TwinMode._ID_NAME_ONLY) TwinRestDTOMapper.TwinMode showSpacesMode) {
        TwinClassSearchRsDTOv1 rs = new TwinClassSearchRsDTOv1();
        try {
            ApiUser apiUser = authService.getApiUser();
            rs.twinClassList(
