    ...
    public ResponseEntity<?> twinClassSearchV1(
        ...
        try {
            ...
            PaginationResult<TwinClassEntity> twinClasses = twinClassService
                    .findTwinClasses(twinClassSearchRestDTOReverseMapper.convert(request), PaginationUtils.createSimplePagination(offset, limit, Sort.unsorted()));
            rs
                    .setTwinClassList(twinClassRestDTOMapper
                            .convertList(twinClasses.getList(), mapperContext))
    ...
    public ResponseEntity<?> twinClassListV1(
        ...
        try {
            ...
            MapperContext mapperContext = new MapperContext()
                    ...
                    .setMode(showHeadClassMode)
                    .setMode(showExtendsClassMode);
            PaginationResult<TwinClassEntity> twinClasses = twinClassService.findTwinClasses(null, PaginationUtils.createSimplePagination(offset, limit, Sort.unsorted()));
            rs
                    .setTwinClassList(twinClassRestDTOMapper.convertList(twinClasses.getList(), mapperContext))
                    .setPagination(paginationMapper.convert(twinClasses))
                    .setRelatedObjects(relatedObjectsRestDTOMapper.convert(mapperContext));
        } catch (ServiceException se) {
            return createErrorRs(se, rs);
