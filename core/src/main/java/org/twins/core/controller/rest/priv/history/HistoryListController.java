...
import org.twins.core.dto.rest.history.HistoryViewRsDTOv1;
...
public class HistoryListController extends ApiController {
    ...
    @ParametersApiUserHeaders
    @Operation(operationId = "historyViewV1", summary = "Return history by id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", content = {
                    @Content(mediaType = "application/json", schema =
                    @Schema(implementation = HistoryViewRsDTOv1.class))}),
            @ApiResponse(responseCode = "401", description = "Access is denied")})
