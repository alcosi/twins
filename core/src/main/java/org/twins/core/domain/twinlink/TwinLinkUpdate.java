...
/**
 * Domain object for twin_link update: wraps the {@link TwinLinkEntity} plus update-only inputs that must not
 * live on the entity itself. Produced by TwinLinkUpdateRestDTOReverseMapper, carried by
 * {@link TwinLinkCUD#getUpdateList()}, consumed by
 * {@link org.twins.core.service.twinlink.TwinLinkService#updateTwinLinks}.
 */
@Data
