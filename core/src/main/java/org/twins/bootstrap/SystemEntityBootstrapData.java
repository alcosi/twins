        ...
        SYSTEM_CLASSES = Collections.unmodifiableList(Arrays.asList(
                ...
                new SystemClass(
                        ...
                        List.of(
                                ...
                                new SystemField(SystemIds.TwinClassField.Base.FLAVOR_ID,        SystemIds.TwinClass.GLOBAL_ANCESTOR, FeaturerTwins.ID_1323, FeaturerTwins.ID_5301, new I18n(SystemIds.I18n.GlobalAncestorField.FLAVOR_NAME, "Flavor"), new I18n(SystemIds.I18n.GlobalAncestorField.FLAVOR_DESCRIPTION, "Flavor"), 4101, "base_flavor_data_list_option_id", false, true, true)
                        ),
                        true,
                        false
                ),
