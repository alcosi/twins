...
BEGIN
    ...
    LOOP
        ...
        SELECT t.head_twin_id,
               ...
               s.permission_schema_id, s.twinflow_schema_id, s.twin_class_schema_id, s.key
        INTO parent_id,
            ...
            space_permission_schema_id, space_twinflow_schema_id, space_twin_class_schema_id, space_alias
        FROM public.twin t
        ...
        END IF;
        IF alias_space_id IS NULL AND local_alias_space_enabled IS TRUE AND space_alias IS NOT NULL
