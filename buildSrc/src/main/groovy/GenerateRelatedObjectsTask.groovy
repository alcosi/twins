...
//                    }
                    ...
                    if (isTwinDTOV2File) {
                        ...
                        if (!classDecl.getMethodsByName('getFieldByKey')) {
                            ...
                            getFieldByKey.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                        }

                        // Add getFieldValueByKey method if missing
                        if (!classDecl.getMethodsByName('getFieldValueByKey')) {
                            def getFieldValueByKey = classDecl.addMethod('getFieldValueByKey', com.github.javaparser.ast.Modifier.Keyword.PUBLIC)
                            getFieldValueByKey.addAnnotation('JsonIgnore')
                            importJsonIgnore = true
                            getFieldValueByKey.setType('String')
                            getFieldValueByKey.addParameter('String', 'fieldKey')
                            getFieldValueByKey.setBody(StaticJavaParser.parseBlock('''{
                                TwinFieldDTOv3 field = getFieldByKey(fieldKey);
                                return field == null ? null : field.getValue();
                            }'''))
                            getFieldValueByKey.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                        }
                        ...
                        if (!classDecl.getMethodsByName('getFieldById')) {
                            ...
                            getFieldById.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                        }
                        ...
                        if (!classDecl.getMethodsByName('initFieldsObjects')) {
                            ...
                            initFieldsObjects.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                        }
                    ...
                    if (!isResponseRelatedObjects && !parentHasRelatedObjects) {
                        ...
                        if (!classDecl.members.any { it instanceof MethodDeclaration && it.nameAsString == 'getRelatedObjects' }) {
                            ...
                            getRelatedObjectsMethod.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                        ...
                        if (!classDecl.members.any { it instanceof MethodDeclaration && it.nameAsString == 'setRelatedObjects' }) {
                            ...
                            setRelatedObjectsMethod.setJavadocComment("Generated by GenerateRelatedObjectsTask")
                    ...
                    relatedFields.each { field ->
                        ...
                        importJsonIgnore = true
                        getter.setJavadocComment("Generated by GenerateRelatedObjectsTask")
